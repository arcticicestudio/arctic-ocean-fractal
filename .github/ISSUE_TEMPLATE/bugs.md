...
- **Ensure the bug has not already been reported by using the [GitHub Issues search](https://github.com/arcticicestudio/arctic-ocean-fractal/issues)** — check if this enhancement has already been suggested. If it has **and the issue is still open**, add your additions as comment to the existing issue instead of opening a new one. If you find a closed issue that seems to be similar to this one, include a link to the original issue in the [metadata head](#metadata-head) section of this issue.
- **Ensure the bug is reproducible and has not already been fixed** — use the [latest version](https://github.com/arcticicestudio/arctic-ocean-fractal/releases/latest) and [`develop`](https://github.com/arcticicestudio/arctic-ocean-fractal/tree/develop) branch.
...
Provide a [MCVE - The Minimal, Complete, and Verifiable Example](https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/CONTRIBUTING.md#mcve)
...
- What is the version of _Arctic Ocean Fractal_ you are running?
