# Contributing to Arctic Ocean Fractal

Thanks for contributing to Arctic Ocean Fractal!

This is a set of guidelines for contributing to Arctic Ocean Fractal. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

As for everything else in the project, the contributions to Arctic Ocean Fractal are governed by our [Code of Conduct][gh-coc]. By participating, you are expected to uphold this code. Please report unacceptable behavior at support@arcticicestudio.com or directly to one of the core team members via [email][gh-mailmap].

## Getting Started

Arctic Ocean Fractal is an open source project and we love to receive contributions from the community! There are many ways to contribute, from [writing- and improving documentation and tutorials](#documentations), [reporting bugs](#bug-reports), [submitting enhancement suggestions](#enhancement-suggestions) which can be incorporated into Arctic Ocean Fractal by [submitting a pull request](#pull-requests).
...
A bug is a _demonstrable problem_ that is caused by the code in the repository. This section guides you through submitting a bug report for Arctic Ocean Fractal. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior and find related reports.
...
- **Did the problem start happening recently** e.g. after updating to a new version of Arctic Ocean Fractal or was this always a problem?
  - If the problem started happening recently, **can you reproduce the problem in an older version of Arctic Ocean Fractal?**
...
- **Explain why this enhancement would be useful** to most Arctic Ocean Fractal users.
...
Arctic Ocean Fractal's documentation consists of guides, which helps users to learn about the project, and the project docs, which serves as a reference.
...
Arctic Ocean Fractal uses the [gitflow][gitflow] branching model. The repository consists of two core branches with an infinite development lifecycle:
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of Arctic Ocean Fractal.
...
Arctic Ocean Fractal adheres to the [Arctic Ice Studio JavaScript Style Guide][gh-styleguide-javascript].

[![][gh-styleguide-javascript-badge]][gh-styleguide-javascript]

### Markdown Style Guide

Arctic Ocean Fractal adheres to the [Arctic Ice Studio Markdown Style Guide][gh-styleguide-markdown].
...
Arctic Ocean Fractal adheres to the [Arctic Ice Studio Git Style Guide][gh-styleguide-git].
...
[gh-branch-develop]: https://github.com/arcticicestudio/arctic-ocean-fractal/tree/develop
[gh-changelog]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/CHANGELOG.md
[gh-coc]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/CODE_OF_CONDUCT.md
[gh-gist]: https://gist.github.com
[gh-issues]: https://github.com/arcticicestudio/arctic-ocean-fractal/issues
[gh-issues-label-question]: https://github.com/arcticicestudio/arctic-ocean-fractal/labels/type-question
[gh-issues-template-bug]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/.github/ISSUE_TEMPLATE/bugs.md
[gh-issues-template-enhancement]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/.github/ISSUE_TEMPLATE/enhancement.md
[gh-issues-template-pr]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/.github/PULL_REQUEST_TEMPLATE.md
[gh-issues-templates]: https://github.com/arcticicestudio/arctic-ocean-fractal/issues/new/choose
[gh-mailmap]: https://github.com/arcticicestudio/arctic-ocean-fractal/blob/develop/.mailmap
[gh-pr]: https://github.com/arcticicestudio/arctic-ocean-fractal/pulls
[gh-releases-latest]: https://github.com/arcticicestudio/arctic-ocean-fractal/releases/latest
